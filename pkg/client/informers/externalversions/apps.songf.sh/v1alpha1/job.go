...
import (
	...
	appssongfshv1alpha1 "songf.sh/songf/pkg/api/apps.songf.sh/v1alpha1"
	versioned "songf.sh/songf/pkg/client/clientset/versioned"
	internalinterfaces "songf.sh/songf/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "songf.sh/songf/pkg/client/listers/apps.songf.sh/v1alpha1"
)
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AppsV1alpha1().Jobs(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AppsV1alpha1().Jobs(namespace).Watch(context.TODO(), options)
			},
		},
		&appssongfshv1alpha1.Job{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *jobInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&appssongfshv1alpha1.Job{}, f.defaultInformer)
}
