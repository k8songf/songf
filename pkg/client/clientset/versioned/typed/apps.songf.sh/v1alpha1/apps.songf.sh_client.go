...
import (
	...
	v1alpha1 "songf.sh/songf/pkg/api/apps.songf.sh/v1alpha1"
	"songf.sh/songf/pkg/client/clientset/versioned/scheme"
)
...
// AppsV1alpha1Client is used to interact with features provided by the apps.songf.sh group.
type AppsV1alpha1Client struct {
	restClient rest.Interface
}

func (c *AppsV1alpha1Client) Jobs(namespace string) JobInterface {
